...
class TCNNAutonerfactoField(Field):
    """Autoberfacto compound Field that uses TCNN
    ...
    Args:
        ...
        use_languagesemantics: whether to use language semantic embeddings
    ...
    def get_outputs(
        ...
        if self.use_semantics:
            ...
            outputs[FieldHeadNames.SEMANTICS] = sem
